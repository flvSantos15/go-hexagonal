...
import (
	...
	application "github.com/flvsantos15/go-hexagonal/application"
...
func (m *MockProductWriter) Save(prouct application.ProductInterface) (application.ProductInterface, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Save", prouct)
	ret0, _ := ret[0].(application.ProductInterface)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockProductWriterMockRecorder) Save(prouct interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Save", reflect.TypeOf((*MockProductWriter)(nil).Save), prouct)
}
...
// Save mocks base method.
func (m *MockProductPersistenceInterface) Save(prouct application.ProductInterface) (application.ProductInterface, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Save", prouct)
	ret0, _ := ret[0].(application.ProductInterface)
	ret1, _ := ret[1].(error)
...
// Save indicates an expected call of Save.
func (mr *MockProductPersistenceInterfaceMockRecorder) Save(prouct interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Save", reflect.TypeOf((*MockProductPersistenceInterface)(nil).Save), prouct)
}
